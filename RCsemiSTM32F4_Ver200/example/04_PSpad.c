...
int main(void)
{
	...
	Modular_USART_Init(BT_BAUDRATE);	// **通信用のピンをUSARTとして初期化する
	Modular_BDSlave_Init(0);	// **コントローラに対してマザーボード側をスレーブとみて初期化する
	
#elif defined(PSPAD_WIRELESS)	// 無線
